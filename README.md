...
# My Portfolio - powered by Gatsby 2.0

- A portfolio website.
- Based on cara-portfolio starter for Gatsby.
...
2. Use the `tailwind.js` file to configure TailwindCSS ([docs](https://tailwindcss.com/docs/configuration)) 
